package com.coroutiner2dbc.filter

import com.coroutiner2dbc.auth.IamAuthentication
import com.coroutiner2dbc.service.AuthService
...
/**
 * packageName    : com.coroutiner2dbc.filter
    ...
    override fun filter(exchange: ServerWebExchange, chain: WebFilterChain): Mono<Void> {
        return mono {
            ...
            if (iam == null) {
                ...
                return@mono resp.setComplete().awaitSingle()
            }
